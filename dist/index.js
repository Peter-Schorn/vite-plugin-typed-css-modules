...
function plugin(options) {
    ...
    const commands = (_c = options === null || options === void 0 ? void 0 : options.commands) !== null && _c !== void 0 ? _c : "both";
    ...
    let srcDir = (_d = options === null || options === void 0 ? void 0 : options.srcDir) !== null && _d !== void 0 ? _d : defaultSrcDir;
     ...
     * false.
     */
    function shouldRunForCommand() {
        if (!viteConfig) {
            return false;
        }
        const result = (commands === "both" ||
            commands === viteConfig.command);
        if (!result) {
            debugLog(`[shouldRunForCommand] Skipping because current command ` +
